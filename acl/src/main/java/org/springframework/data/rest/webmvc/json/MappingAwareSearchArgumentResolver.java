...
public class MappingAwareSearchArgumentResolver implements HandlerMethodArgumentResolver, SortArgumentResolver {

  private final @NonNull JacksonMappingAwarePropertySortTranslator translator;
  private final @NonNull SortArgumentResolver delegate;

  public MappingAwareSearchArgumentResolver(JacksonMappingAwarePropertySortTranslator translator,
