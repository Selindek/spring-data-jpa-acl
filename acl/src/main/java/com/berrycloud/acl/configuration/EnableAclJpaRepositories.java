...
/**
 * Annotation to enable ACL JPA repositories. Will scan the package of the annotated configuration class for Spring Data
 * repositories by default.
 * <p>
 * This annotation is a simple extension of the original {@link EnableJpaRepositories} annotation, the only difference
 * is that it has {@link AclJpaRepositoryFactoryBean} as default {@link #repositoryFactoryBeanClass}.
 *
...
public @interface EnableAclJpaRepositories {
     ...
     * {@link AclJpaRepositoryFactoryBean}.
     *
     * @return
     */
