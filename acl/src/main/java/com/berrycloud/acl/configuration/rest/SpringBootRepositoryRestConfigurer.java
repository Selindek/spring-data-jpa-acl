...
/**
 * A {@code RepositoryRestConfigurer} that applies configuration items from the {@code spring.data.rest} namespace to
 * Spring Data REST. Also, if a {@link Jackson2ObjectMapperBuilder} is available, it is used to configure Spring Data
