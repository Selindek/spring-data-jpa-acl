...
public @interface AclOwner {
  ...
  /**
   * Defines the field in the annotated AclEntity what contains the permission.
   * Using this parameter we can manually define permission-links. (By NOT extending the {@link PermissionLink} class)
   * If this property is set then the value property is ignored.
   * If the annotated AclEntity has no field defined with the given name then a warning will be logged and this annotation is ignored.
   */
