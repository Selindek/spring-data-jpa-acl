...
public class AclAllControllerIntegrationTest {
	...
	public void initTests() {
		mockMvc = MockMvcBuilders.webAppContextSetup(ctx).addFilters(springSecurityFilterChain, aclFilter).build();
    ...
    // @formatter:off
        ...
        .perform(
                ...
                .contentType(MediaType.APPLICATION_JSON).locale(Locale.UK)
    ...
    // @formatter:off
        mockMvc
        .perform(
                get("/persons/"+user2.getId()+"/createdBy/"+user.getId()).header("Authorization", "Basic dXNlcjpwYXNzd29yZA==")
                .contentType(MediaType.APPLICATION_JSON).locale(Locale.UK)
                .accept(MediaType.APPLICATION_JSON))
    ...
    // @formatter:off
        mockMvc
        .perform(
                get("/persons/"+user2.getId()+"/supervisors/"+user.getId()).header("Authorization", "Basic dXNlcjpwYXNzd29yZA==")
                .contentType(MediaType.APPLICATION_JSON).locale(Locale.UK)
                .accept(MediaType.APPLICATION_JSON))
    ...
    @Test
    public void testGivenAdminPermissionWhenCallGetPropertyCollectionWithPaginationThenReturnOnlyAllObjects() throws Exception {
    // @formatter:off
        mockMvc
        .perform(
                get("/persons/"+user2.getId()+"/supervisors?page=1&size=1").header("Authorization", "Basic YWRtaW46cGFzc3dvcmQ=")
                .contentType(MediaType.APPLICATION_JSON).locale(Locale.UK)
                .accept(MediaType.APPLICATION_JSON))
    ...
    @Test
    public void testGivenAdminPermissionWhenCallGetPropertyCollectionWithPaginationAndSortThenReturnOnlyAllObjects() throws Exception {
    // @formatter:off
        mockMvc
        .perform(
                get("/persons/"+user2.getId()+"/supervisors?page=1&size=1&sort=username,desc").header("Authorization", "Basic YWRtaW46cGFzc3dvcmQ=")
                .contentType(MediaType.APPLICATION_JSON).locale(Locale.UK)
                .accept(MediaType.APPLICATION_JSON))
    ...
    // @formatter:off
        mockMvc
        .perform(
                delete("/persons/"+user2.getId()+"/createdBy/"+user.getId()).header("Authorization", "Basic dXNlcjpwYXNzd29yZA==")
                .contentType(MediaType.APPLICATION_JSON).locale(Locale.UK)
                .accept(MediaType.APPLICATION_JSON))
    ...
    // @formatter:off
        mockMvc
        .perform(
                delete("/persons/"+user2.getId()+"/supervisors").header("Authorization", "Basic dXNlcjpwYXNzd29yZA==")
                .contentType(MediaType.APPLICATION_JSON).locale(Locale.UK)
                .accept(MediaType.APPLICATION_JSON))
    ...
    // @formatter:off
        mockMvc
        .perform(
                delete("/persons/"+user2.getId()+"/supervisors/"+user.getId()).header("Authorization", "Basic dXNlcjpwYXNzd29yZA==")
                .contentType(MediaType.APPLICATION_JSON).locale(Locale.UK)
                .accept(MediaType.APPLICATION_JSON))
        ...
        assertThat(personRepositoryNoAcl.findOne(user2.getId()).getSupervisors(),not(hasItem(hasProperty("username",is("user")))));
    }
    ...
    public void testGivenNoPermissionWhenDeletePropertyCollectionElementThenElementIsNotDeleted() throws Exception {
        ...
        mockMvc
        .perform(
                delete("/persons/"+user2.getId()+"/supervisors/"+admin.getId()).header("Authorization", "Basic dXNlcjpwYXNzd29yZA==")
                .contentType(MediaType.APPLICATION_JSON).locale(Locale.UK)
                .accept(MediaType.APPLICATION_JSON))
        ...
        assertThat(personRepositoryNoAcl.findOne(user2.getId()).getSupervisors(),hasItem(hasProperty("username",is("admin"))));
    }
    ...
    @Test
    public void testGivenPermissionOnObjectWhenPutPropertyObjectWithoutPermissionThenPropertyIsNotAdded() throws Exception {
    // @formatter:off
        mockMvc
        .perform(
                put("/persons/"+user2.getId()+"/controlled").header("Authorization", "Basic dXNlcjpwYXNzd29yZA==") // user
    ...
    @Test
    public void testGivenPermissionOnObjectWhenPutPropertyCollectionThenOnlyPropertiesWithPermissionAreAdded() throws Exception {
    // @formatter:off
        mockMvc
        .perform(
                put("/persons/"+user3.getId()+"/supervisors").header("Authorization", "Basic dXNlcjpwYXNzd29yZA==") // user
                .contentType(RestMediaTypes.TEXT_URI_LIST).locale(Locale.UK)
                .content("/persons/"+admin.getId()+"\n/persons/"+user.getId())
                .accept(MediaType.APPLICATION_JSON))
        ...
        assertThat(personRepositoryNoAcl.findOne(user3.getId()).getSupervisors(),hasItem(hasProperty("username",is("user"))));
        assertThat(personRepositoryNoAcl.findOne(user3.getId()).getSupervisors(),not(hasItem(hasProperty("username",is("admin")))));

    }
    
    @Test
    public void testGivenPermissionOnObjectWhenPostPropertyCollectionThenOnlyPropertiesWithPermissionAreAdded() throws Exception {
    // @formatter:off
        mockMvc
        .perform(
    ...
    @Test
    public void testGivenPermissionOnObjectWhenPostPropertyCollectionThenOnlyPropertiesWithPermissionAreAddedToTheCollection() throws Exception {
    // @formatter:off
        mockMvc
        .perform(
        ...
        assertThat(personRepositoryNoAcl.findOne(user2.getId()).getSupervisors(),hasItem(hasProperty("username",is("user"))));
        assertThat(personRepositoryNoAcl.findOne(user2.getId()).getSupervisors(),hasItem(hasProperty("username",is("admin"))));
        assertThat(personRepositoryNoAcl.findOne(user2.getId()).getSupervisors(),hasItem(hasProperty("username",is("user3"))));
        assertThat(personRepositoryNoAcl.findOne(user2.getId()).getSupervisors(),not(hasItem(hasProperty("username",is("user4")))));
